        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-[0.8rem] lg:text-[1.1rem]  lg:px-[7rem]">
              ...
              son: Motobombas, Desbrozadoras, Podadoras, Compresores de Aire, Cortasetos y más!<br /><br />
              Tenemos las refacciones para tus equipos eléctricos y a gasolina como son:
              Carburadores, Diafragmas, Cebadores, Filtros, Mangueras, Conexiones, Chicotes, Llaves de paso,
              Empaques, Pistones, Anillos y muchas refacciones más.<br /><br />
