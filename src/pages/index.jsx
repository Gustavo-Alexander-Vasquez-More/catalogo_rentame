  ...
  return (
    <>
      ...
      {loadingImages && productos_paginados.length > 0 && (
        <div className=" w-full text-center h-screen bg-[#3E4B8A] gap-3 flex-col flex items-center justify-center">
          <div
            class="spinner-border text-[white] w-[3rem] h-[3rem]"
            role="status"
          >
            <span class="visually-hidden">Loading...</span>
          </div>
          <p className="text-[white] text-[1.1rem] font-semibold">
            Cargando equipos
          </p>
        </div>
      )}
