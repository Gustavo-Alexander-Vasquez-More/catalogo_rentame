...
export default function centroServicio() {
  ...
  RM Centro de Servicio: Soluciones Técnicas que Mantienen tu Negocio en Marcha.</p>
    <p className="text-lg mt-5">
      En <span className="text-blue-600 font-bold">RM CENTRO DE SERVICIO</span>, nos especializamos en la reparación, mantenimiento y renovación de herramientas eléctricas y de combustión.
    </p>

    <p className="mt-4 text-lg">
    Ubicados en Ciudad del Carmen, Campeche, proporcionamos todo lo necesario para
garantizar que tus equipos se mantengan en condiciones óptimas. Nuestros equipos de
técnicos altamente capacitados están a tu disposición para asesorarte y resolver cualquier
inconveniente que pueda surgir con tu maquinaria ligera, ya sea para la construcción u otros
oficios.
    </p>
    <p className="mt-4 text-lg">
    Confía en nosotros para mantener tu maquinaria en un estado excelente y asegurarte de que
tus equipos estén siempre listos para cualquier proyecto que se presente. En nuestro taller,
puedes reparar y dar mantenimiento a una amplia gama de equipos, desde taladros hasta
vibrocompactadoras.
    </p>
    
    <p className="mt-4 text-lg">
    Contamos con un extenso surtido de refacciones para ofrecerte una atención y reparación
rápidas y eficaces.
    </p>

    <p className="mt-4 text-lg">
    Además, para que tu trabajo no se detenga, te ofrecemos la opción de renta de la misma
herramienta que nos traigas a nuestro centro de servicio, reduciendo a cero los tiempos
perdidos y manteniendo tu empresa operando al 100%.
    </p>
  </div>
...
<section className="w-full px-[1rem] lg:px-[4rem] pb-16 mt-[2rem] lg:mt-0">
  <div className="bg-[#F3F4F6] rounded-2xl p-8 shadow-lg flex flex-col lg:flex-row gap-8 items-center justify-center">
    ...
    <div className="lg:w-1/2 w-full text-gray-700">
      <h2 className="text-2xl font-bold text-blue-700 mb-3">Así luce nuestro taller</h2>
      <p className="text-lg">
        Contamos con instalaciones completamente equipadas para brindar un servicio de calidad y rapidez. Nuestro taller está diseñado para atender maquinaria eléctrica y de combustión con eficiencia y precisión.
      </p>
      <p className="text-lg mt-3">
        Visítanos y conoce cómo cuidamos de tus equipos en un entorno profesional.
      </p>
    </div>
  </div>
</section>
