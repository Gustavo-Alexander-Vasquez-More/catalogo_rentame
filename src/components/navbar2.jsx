...
export default function navbar2({ isOpen, setIsOpen }) {
  ...
  return (
    ...
    <a href="tel:+529381958284" className="border-white border-[2px] hidden lg:flex items-center gap-1 rounded-2 px-3 text-white text-[1.2rem] py-3 hover:bg-[#11283D] transition-colors duration-500">
    ...
    {/* EN PANTALLA PEQUEÑA */}
      ...
      <div
        className={`flex lg:hidden flex-col bg-[#c70000] items-start pb-[1rem] z-50 lg:text-[1.2rem] gap-2 sm:flex-row sm:m-0 ${isOpen ? 'block transition-all duration-500 ' : 'hidden'} `}
      >
        <a href="/" className="text-[white] hover:bg-gray-200 transition-colors duration-500 w-full text-left px-4 py-2 rounded hover:text-gray-900">
          Inicio
        </a>
        <a href="/renta-equipos" className="text-[white] hover:bg-gray-200 w-full text-left transition-colors duration-500 rounded px-4 py-2 hover:text-gray-900">
        Equipos en renta
        </a>
        <a href="/venta-equipos" className="text-[white] hover:bg-gray-200 w-full text-left transition-colors duration-500 rounded px-4 py-2 hover:text-gray-900">
        Equipos en venta
        </a>
        <a href="/centro_servicio" className="text-[white] hover:bg-gray-200 w-full text-left transition-colors duration-500 rounded px-4 py-2 hover:text-gray-900">
        Centro de Servicio
        </a>
        <a href="/about_us" className="text-[white] hover:bg-gray-200 w-full text-left transition-colors duration-500 rounded px-4 py-2 hover:text-gray-900">
        Sobre nosotros
        </a>
        <button onClick={()=>{setIsOpen(false), openFormulario()}} className="text-[white] hover:bg-gray-200 w-full text-left transition-colors duration-500 rounded px-4 py-2 hover:text-gray-900">
        Contacto
        </button>
      </div>
    </nav>
