...
<footer className="bg-gradient-to-br from-[#222d72] to-[#1a2458] text-white pt-16 pb-10 px-6 lg:px-20 w-full">
  <div className="grid lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
    ...
    <a
       href="https://wa.link/w31sh7" target="_blank" rel="noopener noreferrer"
      >
    ...
    <div>
      ...
      <ul className="text-sm text-gray-300 space-y-2">
        <li><strong>Dirección:</strong> Calle 38 No: 128 entre 35 y 37 Col. Tecolutla CP: 24100 Cd. Del Carmen, Campeche.</li>
        <li><strong>Teléfono:</strong> <a className="hover:text-red-500 hover:underline" href="tel:+529381958284">+52 938 195 8284</a></li>
        <li><strong>Email:</strong> <a className="hover:text-red-500 hover:underline" href="mailto:contacto@rentamecarmen.com.mx">contacto@rentamecarmen.com.mx</a></li>
        <li><strong>Horario:</strong> Lun - Vie: 9am - 7pm | Sáb: 9am - 3pm</li>
      </ul>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 mt-2">
        <a href="https://www.facebook.com/p/Rentame-Carmen-100094870352555/" target="_blank" className="hover:text-red-500 flex flex-col items-center"><i className="fab fa-facebook-f"></i> Facebook<svg class="w-8 h-8 text-white bg-primary border-[3px] rounded-full" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path fill-rule="evenodd" d="M13.135 6H15V3h-1.865a4.147 4.147 0 0 0-4.142 4.142V9H7v3h2v9.938h3V12h2.021l.592-3H12V6.591A.6.6 0 0 1 12.592 6h.543Z" clip-rule="evenodd"/>
</svg>
</a>
        <a href="https://search.google.com/local/writereview?placeid=ChIJUSFC42up8YURtPF2RUOE55o" target="_blank" className="hover:text-red-500 flex flex-col items-center"><i className="fab fa-instagram"></i> Google Reviews<svg class="w-8 h-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <div className="border-t  mt-10 pt-6 text-center text-sm text-gray-300">
    © {new Date().getFullYear()} Rentame Carmen. Todos los derechos reservados.
  </div>
</footer>
