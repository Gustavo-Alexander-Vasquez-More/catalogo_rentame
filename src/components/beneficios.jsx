...
export default function beneficios() {
  ...
  <div className="flex justify-between items-stretch gap-6 w-full">
    ...
    <div className="flex flex-col items-center text-center w-1/3 px-4 py-4 bg-[#2b3aa0] rounded-xl hover:scale-105 transition-transform duration-300">
      <svg className="w-8 h-8 mb-3 text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      ...
      <p className="text-sm">Nos destacamos por ir más allá de las expectativas de nuestros clientes, siempre con total transparencia y sin sorpresas desagradables.</p>
    </div>
    ...
    <div className="flex flex-col items-center text-center w-1/3 px-4 py-4 bg-[#2b3aa0] rounded-xl hover:scale-105 transition-transform duration-300">
      ...
      <p className="text-sm">Contamos con la experiencia y el respaldo técnico necesarios para ofrecer alquileres sin sorpresas, gracias a nuestro equipo en constante actualización.</p>
    </div>
    ...
    <div className="flex flex-col items-center text-center w-1/3 px-4 py-4 bg-[#2b3aa0] rounded-xl hover:scale-105 transition-transform duration-300">
      ...
      <p className="text-sm">Nos distinguimos por nuestra integridad y compromiso con la transparencia: siempre devolvemos las piezas dañadas de su equipo, o el servicio no tiene costo.</p>
    </div>
  </div>
</div>
